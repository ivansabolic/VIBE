...
def WeakerResnet(num, num_layers, num_classes=10):
    if num == 18:
        return _WeakerResNet(num_layers, BasicBlock, [2,2,2,2], num_classes)
    elif num == 34:
        return _WeakerResNet(num_layers, BasicBlock, [3,4,6,3], num_classes)
    elif num == 50:
        return _WeakerResNet(num_layers, Bottleneck, [3,4,6,3], num_classes)
    elif num == 101:
        return _WeakerResNet(num_layers, Bottleneck, [3,4,23,3], num_classes)
    elif num == 152:
        return _WeakerResNet(num_layers, Bottleneck, [3,8,36,3], num_classes)
    else:
        raise NotImplementedError
